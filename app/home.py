...
AUTHORIZED_EMAIL = "ocp@gmail.com"
AUTHORIZED_PASSWORD = "ocp@jorf@lasfer"
    ...
    with header_right:
        ...
        st.markdown(
            ...
            <div class="company-subtitle">
                CAP Supervision • Plateforme de supervision industrielle
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with login_column:
        ...
        st.markdown(
            ...
            <div class="login-subtitle">
                Accédez à votre espace de supervision industrielle
            </div>
            """,
            unsafe_allow_html=True
        )
...
def dashboard_page():
    ...
    st.markdown(
        ...
        <div class="dashboard-subtitle">
            Vue globale des données de l'unité de concentration d'acide phosphorique
        </div>
        """,
        unsafe_allow_html=True
    )
    ...
    if not all([
        ...
        st.warning(
            "Certaines sources de données ne sont pas accessibles. "
        ...
        st.warning(
            f"Attention : {anomalies['count']} anomalies détectées."
        )
        ...
        st.error(
            ...
            f"{anomalies['count']} anomalies détectées."
        )
    ...
    with module_col1:
        ...
        st.info(
            "📊 Mesures — Consultation et suivi des variables du procédé."
        )

        st.warning(
            "⚠ Anomalies — Détection des comportements anormaux."
        )
    ...
    with module_col2:
        ...
        st.error(
            "🚨 Alarmes — Suivi des alarmes et de leur criticité."
        )

        st.success(
            "⏹ Arrêts — Analyse des arrêts et de leurs causes."
        )
    ...
    st.caption(
        "OCP Group • CAP Supervision • Plateforme de supervision industrielle"
    )
